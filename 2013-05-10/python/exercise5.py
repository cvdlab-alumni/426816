...
p0 = [[-5,0,-0.7],[-5,0.4,-0.7],[-5,0.5,0],[-5,0.4,0.7],[-5,0,0.7]]
c0 = BEZIER(S1)(p0)
l0 = MAP(c0)(Dom1D)

p1 = [[-4,0,-0.9],[-4,1,-0.9],[-4,1.1,0],[-4,1,0.9],[-4,0,0.9]]
c1 = BEZIER(S1)(p1)
l1 = MAP(c1)(Dom1D)

p2 = [[-3,0,-1],[-3,1.3,-1],[-3,1.5,0],[-3,1.3,1],[-3,0,1]]
c2 = BEZIER(S1)(p2)
l2 = MAP(c2)(Dom1D)

s0 = BEZIER(S2)([c0,c1,c2])
surf0 = MAP(s0)(Dom2D)

p3 = [[-2,0,-1.1],[-2,1.15,-1.1],[-2,1.25,0],[-2,1.15,1.1],[-2,0,1.1]]
c3 = BEZIER(S1)(p3)
l3 = MAP(c3)(Dom1D)

p4 = [[-1,0,-1.1],[-1,1.25,-1.1],[-1,1.35,0],[-1,1.25,1.1],[-1,0,1.1]]
c4 = BEZIER(S1)(p4)
l4 = MAP(c4)(Dom1D)

p5 = [[0,0,-1.1],[0,1.9,-1.1],[0,2,0],[0,1.9,1.1],[0,0,1.1]]
c5 = BEZIER(S1)(p5)
l5 = MAP(c5)(Dom1D)

s1 = BEZIER(S2)([c2,c3,c4,c5])
surf1 = MAP(s1)(Dom2D)

p6 = [[0.7,0.5,-1.1],[-0.1,1.7,-1.1],[-0.1,2,0],[-0.1,1.7,1.1],[0.7,0.5,1.1]]
c6 = BEZIER(S1)(p6)
l6 = MAP(c6)(Dom1D)

p7 = [[1.3,0.5,-1.1],[2.05,2.2,-1.1],[2.05,2.5,0],[2.05,2.2,1.1],[1.3,0.5,1.1]]
c7 = BEZIER(S1)(p7)
l7 = MAP(c7)(Dom1D)

p8 = [[2,0,-1.1],[2,2.5,-1.1],[2,2.6,0],[2,2.5,1.1],[2,0,1.1]]
c8 = BEZIER(S1)(p8)
l8 = MAP(c8)(Dom1D)

p9 = [[-0.1,0,-1.1],[-0.1,0.6,-1.1]]
c9 = BEZIER(S1)(p9)
l9 = MAP(c9)(Dom1D)

p9b = [[-0.1,0,1.1],[-0.1,0.6,1.1]]
c9b = BEZIER(S1)(p9b)
l9b = MAP(c9b)(Dom1D)

p10 = [[2,0,-1.1],[2,0.6,-1.1]]
c10 = BEZIER(S1)(p10)
l10 = MAP(c10)(Dom1D)

p10b = [[2,0,1.1],[2,0.6,1.1]]
c10b = BEZIER(S1)(p10b)
l10b = MAP(c10b)(Dom1D)
...
s5 = BEZIER(S2)([c9b,c10b])
surf5 = MAP(s5)(Dom2D_inv)

p11 = [[3,0,-1],[3,2.4,-1],[3,2.5,0],[3,2.4,1],[3,0,1]]
c11 = BEZIER(S1)(p11)
l11 = MAP(c11)(Dom1D)

p12 = [[4,0,-0.8],[4,1.8,-0.8],[4,1.9,0],[4,1.8,0.8],[4,0,0.8]]
c12 = BEZIER(S1)(p12)
l12 = MAP(c12)(Dom1D)

p13 = [[5.2,0,-0.4],[5.2,0.5,-0.4],[5.2,0.6,0],[5.2,0.5,0.4],[5.2,0,0.4]]
c13 = BEZIER(S1)(p13)
l13 = MAP(c13)(Dom1D)

s6 = BEZIER(S2)([c8,c11,c12,c13,[5.3,0,0]])
surf6 = MAP(s6)(Dom2D)

chassis1 = COLOR(RED)(STRUCT([surf0,surf1,surf2,surf3,surf4,surf5,surf6]))

#superfice bassa

p0 = [[-5,0,-0.7],[-5,-0.7,-0.7],[-5,-0.8,0],[-5,-0.7,0.7],[-5,0,0.7]]
c0 = BEZIER(S1)(p0)
l0 = MAP(c0)(Dom1D)

p1 = [[-4,0,-1.2],[-4,-1.2,-1.2],[-4,-1.3,0],[-4,-1.2,1.2],[-4,0,1.2]]
c1 = BEZIER(S1)(p1)
l1 = MAP(c1)(Dom1D)

p2 = [[-3,0,-1.2],[-3,-1.2,-1.2],[-3,-1.3,0],[-3,-1.2,1.2],[-3,0,1.2]]
c2 = BEZIER(S1)(p2)
l2 = MAP(c2)(Dom1D)

p3 = [[2,0,-1.2],[2,-1.2,-1.2],[2,-1.3,0],[2,-1.2,1.2],[2,0,1.2]]
c3 = BEZIER(S1)(p3)
l3 = MAP(c3)(Dom1D)

p4 = [[3,0,-1.23],[3,-1,-1.23],[3,-1.1,0],[3,-1,1.23],[3,0,1.23]]
c4 = BEZIER(S1)(p4)
l4 = MAP(c4)(Dom1D)

p5 = [[4,0,-0.85],[4,-1,-0.85],[4,-1.1,0],[4,-1,0.85],[4,0,0.85]]
c5 = BEZIER(S1)(p5)
l5 = MAP(c5)(Dom1D)

p6 = [[5.2,0,-0.6],[5.2,-0.5,-0.6],[5.2,-0.6,0],[5.2,-0.5,0.6],[5.2,0,0.6]]
c6 = BEZIER(S1)(p6)
l6 = MAP(c6)(Dom1D)

s7 = BEZIER(S2)([c0,c1,c2,c3,c4,c5,c6,[5.3,0,0]])
surf7 = MAP(s7)(Dom2D_inv)

chassis2 = COLOR(RED)(STRUCT([surf7]))


#griglia

p01 = [[-5,0,-0.7],[-5,0.4,-0.7],[-5,0.5,0],[-5,0.4,0.7],[-5,0,0.7]]
c01 = BEZIER(S1)(p01)
l01 = MAP(c01)(Dom1D)

p02 = [[-5,0,-0.7],[-5,-0.7,-0.7],[-5,-0.8,0],[-5,-0.7,0.7],[-5,0,0.7]]
c02 = BEZIER(S1)(p02)
l02 = MAP(c02)(Dom1D)

s8 = BEZIER(S2)([c01,[-5.3,0,0]])
surf8 = MAP(s8)(PROD([INTERVALS(1)(10),INTERVALS(1)(10)]))

s9 = BEZIER(S2)([c02,[-5.3,0,0]])
surf9 = MAP(s9)(PROD([INTERVALS(1)(10),INTERVALS(1)(10)]))

chassis3 = SKELETON(1)(STRUCT([surf8,surf9]))

model = STRUCT([prof,wheel1,wheel2,wheel3,wheel4,R([1,2])(0.2)(T([1,2])([0.5,0.9])(S([1,2,3])([0.15,0.15,0.15])(steeringwheel))),chassis1,chassis2,chassis3])
